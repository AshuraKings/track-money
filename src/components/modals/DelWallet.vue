...
import { delWallet } from '../../api/master'

const { wallet } = defineProps({ wallet: Object, })
...
<template>
    ...
    <BaseModal @onClose="cancelled" :open>
        <p>
            Are you sure for deleting wallet <b>{{ wallet.nm }}</b> ?
        </p>
