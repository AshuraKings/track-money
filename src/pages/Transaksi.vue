      ...
      <div
        ...
        <div class="sm:flex">
          <div class="flex items-center mb-4 sm:mb-0">
            ...
            <SearchInput label="End Date" type="date" name="end" v-model="end" :disabled="!start" :min="start" />
        ...
        <div>
          <div class="max-w-full overflow-auto">
            <table class="mt-4 min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
              ...
              <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <tr v-for="t, i in transaksies" :key="i" class="hover:bg-gray-100 dark:hover:bg-gray-700">
          ...
          <Pagination :limit="20" :page :count @increase="() => { page += 20; reload(); }"
            @decrease="() => { page -= 20; reload(); }" />
        </div>
      </div>
    </div>
  </AuthenticatedLayout>
